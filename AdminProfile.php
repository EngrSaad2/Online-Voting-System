 ...
 <div class="container">
  <div class="row">
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		...
		<label class='col-md-3 col-md-3 control-label'>Your Name </label> 
		     <div class='col-sm-9'>
			<input name='election' class='form-control' type='text' value='Nayana Samarasinghe'  disabled>
			</div> 
            </div>				
		<div class='form-group '>
		<label class='col-md-3 col-md-3 control-label'>Occupation</label> 
		<div class='col-sm-9'>
		<input name='election' class='form-control' type='text' value='Election officer'  disabled>	
				</div>
				</div>
		<div class='form-group '>
		<label class='col-md-3 col-md-3 control-label'>Register Date</label>
            <div class='col-sm-9'>		
			<input name='election' class='form-control' type='text' value='2015.04.13'  disabled>	
				</div> 
                </div>				
		<div class='form-group '>
