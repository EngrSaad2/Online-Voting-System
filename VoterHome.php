                ...
                <div class="col-lg-12">
                    <div class="intro-message">
                       ...
                       <ul class="list-inline intro-social-buttons">
                            <li>
                                <a href="vote.php" class="btn btn-default btn-lg"><i class="glyphicon glyphicon-thumbs-up"></i> <span class="network-name">Voting</span></a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="Profile.php" class="btn btn-default btn-lg"><i class="glyphicon glyphicon-user"></i> <span class="network-name">Profile</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
       ...
       <div class="container">
            <div class="row">
                <div class="col-lg-5 col-sm-6">
                    ...
                    <h2 class="section-heading">Smarter Way to browse on Social Media</h2>
                    <p class="lead">The social media search tools find information from multiple social networking sites 
					including Facebook, Twitter, Google+ and LinkedIn at the same time. ... .</p>
                </div>
                <div class="col-lg-5 col-lg-offset-2 col-sm-6">
				   ...
				   <br>
                    <ul class="social-network social-circle">
                        ...
                        <li><a href="https://twitter.com/lanka_elections" target="_blank" class="icoTwitter" title="Twitter"><i class="fa fa-twitter"></i></a></li>
