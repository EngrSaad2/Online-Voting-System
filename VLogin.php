...
echo 'window.location.href = "VoterLogin.php";';
echo '</script>';
}
...
$query = mysql_query("select username , password from voter where password='$password' AND username='$username'", $connection);
