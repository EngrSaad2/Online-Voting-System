...
<head>
    ...
    <meta name="description" content="automatic redirection">
                ...
                <div class="col-lg-12">
                    <div class="intro-message">
                       ...
                       <ul class="list-inline intro-social-buttons">
                            <li>
                                <a href="Cprofile.php" class="btn btn-default btn-lg"><i class="glyphicon glyphicon-thumbs-up"></i> <span class="network-name">Profile</span></a>
                            </li>
                            <li>
                                <a href="Cresult.php" class="btn btn-default btn-lg"><i class="glyphicon glyphicon-registration-mark"></i> <span class="network-name">Results</span></a>
                            </li>
                            <li>
                                <a href="report.php" class="btn btn-default btn-lg"><i class="glyphicon glyphicon-signal"></i> <span class="network-name">Reports</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
...
?>
    ...
    <div class="banner">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <h2>Start your vote........</h2>
                </div>
                <div class="col-lg-6">
                    <ul class="list-inline intro-social-buttons">
                            <li>
                                <a href="#" class="btn btn-default btn-lg"><i class="glyphicon glyphicon-thumbs-up"></i> <span class="network-name">Profile</span></a>
                            </li>
                            <li>
                                <a href="result.php" class="btn btn-default btn-lg"><i class="glyphicon glyphicon-registration-mark"></i> <span class="network-name">Results</span></a>
                            </li>
                            <li>
                                <a href="reports.php" class="btn btn-default btn-lg"><i class="glyphicon glyphicon-signal"></i> <span class="network-name">Reports</span></a>
                            </li>
                        </ul>
                </div>
            </div>
